// Importation de la fonction à tester et du modèle Post
const { createPost } = require('../../controllers/post');
const Post = require('../../models/post');

// Mocker le modèle Post pour éviter les interactions avec la base de données
...
describe('createPost', () => {
  ...
  it('should create a post and return status 201', async () => {
    const mockPost = { _id: 'newPostId' }; // Simulez l'ID du nouveau post
